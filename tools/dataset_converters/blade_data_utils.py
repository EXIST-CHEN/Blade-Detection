...
def get_image_path(idx,
                   ...
                   file_tail='.png',
                   use_prefix_id=False):
    return get_blade_info_path(idx, prefix, info_type, file_tail, training,
...
def get_label_path(idx,
                   ...
                   info_type='label_2',
                   use_prefix_id=False):
    return get_blade_info_path(idx, prefix, info_type, '.txt', training,
                               relative_path, exist_check, use_prefix_id)
...
def get_velodyne_path(idx,
                      ...
                      exist_check=True,
                      use_prefix_id=False):
    return get_blade_info_path(idx, prefix, 'velodyne', '.bin', training,
                               relative_path, exist_check, use_prefix_id)
...
def get_calib_path(idx,
                   ...
                   exist_check=True,
                   use_prefix_id=False):
    return get_blade_info_path(idx, prefix, 'calib', '.txt', training,
                               relative_path, exist_check, use_prefix_id)
...
def get_pose_path(idx,
                  ...
                  exist_check=True,
                  use_prefix_id=False):
    return get_blade_info_path(idx, prefix, 'pose', '.txt', training,
                               relative_path, exist_check, use_prefix_id)
...
def get_timestamp_path(idx,
                       ...
                       exist_check=True,
                       use_prefix_id=False):
    return get_blade_info_path(idx, prefix, 'timestamp', '.txt', training,
                               relative_path, exist_check, use_prefix_id)
...
def get_blade_image_info(path,
    ...
    """
    Blade annotation format version 2:
    {
        [optional]points: [N, 3+] point cloud
        [optional, for blade]image: {
            image_idx: ...
            image_path: ...
            image_shape: ...
        }
        ...
        annos: {
            ...
            [optional]difficulty: blade difficulty
...
class WaymoInfoGatherer:
    ...
    Waymo annotation format version like Blade:
    {
        [optional]points: [N, 3+] point cloud
        [optional, for blade]image: {
            image_idx: ...
...
def blade_anno_to_label_file(annos, folder):
    folder = Path(folder)
    for anno in annos:
        ...
        for j in range(anno['bbox'].shape[0]):
            ...
            label_line = blade_result_line(label_dict)
...
def blade_result_line(result_dict, precision=4):
