...
class BladeDataset(Det3DDataset):
    ...
    This class serves as the API for experiments on the `Blade Dataset`.
    ...
    """
    # TODO: use full classes of blade
    METAINFO = {
        'classes': ('Blade', )
    }
    ...
    def parse_ann_info(self, info: dict) -> dict:
        ...
        Returns:
            dict: Annotation information consists of the following keys:
                ...
                - difficulty (int): Difficulty defined by Blade.
        ...
        # in blade, lidar2cam = R0_rect @ Tr_velo_to_cam
