...
from mmdet3d.evaluation import do_eval, eval_class, blade_eval
...
def test_do_eval():
    ...
    gt_name = np.array(
        ['Blade', 'Blade', 'Blade', 'Blade', 'Blade', 'DontCare', 'DontCare'])
    ...
    dt_name = np.array(['Blade', 'Blade', 'Blade', 'Blade', 'Blade'])
...
def test_blade_eval():
    ...
    current_classes = [1, 2, 0]
    result, ret_dict = blade_eval([gt_anno], [dt_anno], current_classes)
    assert np.isclose(ret_dict['BLADE/Overall_2D_AP11_moderate'],
                      9.090909090909092)
    assert np.isclose(ret_dict['BLADE/Overall_2D_AP11_hard'],
                      9.090909090909092)
    assert np.isclose(ret_dict['BLADE/Overall_2D_AP40_moderate'],
                      0.8333333333333334)
    assert np.isclose(ret_dict['BLADE/Overall_2D_AP40_hard'],
                      0.8333333333333334)
